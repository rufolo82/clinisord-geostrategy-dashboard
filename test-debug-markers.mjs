...
try {
  ...
  // Take screenshot
  await page.screenshot({ path: 'test-madrid-initial.png' });
  console.log('Screenshot saved: test-madrid-initial.png');
  ...
  if (barcelonaBtn) {
    ...
    // Take screenshot
    await page.screenshot({ path: 'test-barcelona.png' });
    console.log('Screenshot saved: test-barcelona.png');
    ...
    if (madridBtn) {
      ...
      madridMarkers = await page.$$('.leaflet-marker-icon');
      console.log(`Markers after switching back to Madrid: ${madridMarkers.length}`);
      
      // Take screenshot
      await page.screenshot({ path: 'test-madrid-back.png' });
      console.log('Screenshot saved: test-madrid-back.png');
    } else {
      console.log('Madrid button not found');
    }
